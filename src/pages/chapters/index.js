...
import { Box, Heading, Header, Textarea, Button, Tooltip, IconButton, Spinner } from '@primer/react';
...
export default function ChapterDisplay({ storyNames, messageIDs, chapters, sessionID}) {
